...
@RequiredArgsConstructor									// final 선언으로 인한 안전장치
@MapperScan(basePackages={"com.gdu.home.mapper"})           // @Mapper가 존재하는 패키지를 작성한다.
@PropertySource(value={"classpath:application.yaml"})  		// application.properties 파일의 속성을 읽어 오자!
